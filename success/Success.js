  ...
  return (
    <><Video
      ...
      <Image source={success} style={styles.success}/>
        <Text style={styles.titleLog}>Success</Text>
        <Text style={styles.titleCong}>Congratulations! Your account is now active!</Text>
          <TouchableOpacity
            style={styles.Button1}>
            <Text style={styles.text1}>Go to the platform</Text>
          </TouchableOpacity>
